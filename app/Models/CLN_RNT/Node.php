...
use App\Services\CLN_RNT\Binding;
...
//    private bool $autoThreshold;
    ...
    )
    {
        ...
        $this->activation = 0.0;
        $this->thresholdInput = 1;
        if ($type == 'AND') {
            $this->thresholdInput = (int)$metadata['value'];
        }
        $this->threshold = 1.0;
        $this->bindings = [];
    }
...
//    }
     ...
     */
    public function activate(float $level): bool
    {
        // Record activation
    ...
    public function inhibit(): void {
        $this->inhibited = true;
    }

    public function disinhibit(): void {
        $this->inhibited = false;
    }

    public function addBinding(Binding $binding): void {
        $this->bindings[$binding->headTime] = $binding;
    }

    public function getLastBinding(): ?Binding {
        $lastTime = -1;
        foreach ($this->bindings as $time => $binding) {
        ...
        return $this->bindings[$lastTime] ?? null;
    }
...
//     */
//    public function addInput(Node $node): self
//    {
...
//     */
//    public function addOutput(Node $node): self
//    {
...
//     *
//     * @param \App\Models\CLN\L5Layer $l5 L5 layer containing this partial
//     */
//    public function confirmConstruction(\App\Models\CLN\L5Layer $l5): void
//    {
...
//        $matcher = new \App\Services\CLN\GraphPatternMatcher;
//
//        //$l23Nodes = [$this];
//        debug('##'. ($this->metadata['name'] ?? $this->id));
//        // Delegate to service
//        \App\Services\CLN\ConstructionActivationService::checkActivation(
//            $this,
//            $matcher,
//            $l5
//        );
...
//     */
//    public function linkToConstruction(Node $construction, array $graphNode, GraphPatternMatcher $matcher, L5Layer $l5): void
//    {
...
//        $patternMatcher = new \App\Services\CLN\PatternMatcher;
...
//     *
//     * @param \App\Models\CLN\L5Layer|null $l5 L5 layer for accessing helpers
//     * @param \App\Services\CLN\ColumnSequenceManager|null $manager Manager for registration
//     */
//    public function generatePrediction(?\App\Models\CLN\L5Layer $l5 = null, ?\App\Services\CLN\ColumnSequenceManager $manager = null): void
//    {
...
//
//        // Delegate to service
//        \App\Services\CLN\PredictionGenerationService::calculatePrediction($this, $manager, $l5);
//    }
//
//    /**
