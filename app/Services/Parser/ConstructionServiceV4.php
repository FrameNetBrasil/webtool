...
class ConstructionServiceV4
{
     ...
     */
    public function compileAndStore(CreateData $data): int
    {
     ...
     */
    public function update(int $idConstruction, UpdateData $data): void
    {
        // Validate and compile pattern
        $validation = $this->validatePattern($data->pattern);
                ...
                if ($exists && $overwrite) {
                    ...
                    if ($existingConstruction) {
                        $updateData = new UpdateData(
                            $existingConstruction->idConstruction,
                            ...(array) $createData
                        );
                        $this->update($existingConstruction->idConstruction, $updateData);
                    }
                } else {
                    $this->compileAndStore($createData);
                }
