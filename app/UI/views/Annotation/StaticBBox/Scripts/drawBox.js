...
annotation.drawBox = {
    ...
    color: annotation.objects.colors[0],
    startX: 0,
    startY: 0,
    offsetX: 0,
    offsetY: 0,
    ...
    config() {
        let image = document.getElementById("imageStaticBBox");
        const rect= image.getBoundingClientRect();
        console.log(rect,$('#imageStaticBBox').offset());
        let $canvas = document.querySelector('#canvas');
        annotation.drawBox.offsetX = rect.x;
        annotation.drawBox.offsetY = rect.y;
        $canvas.width = annotation.dimensions.imageWidth;
        $canvas.height = annotation.dimensions.imageHeight;
