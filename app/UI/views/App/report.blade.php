@php
    $reports = [
        ...
        'classes' => ['Class', '/report/class', 'List of all ontological classes.','ui::icon.frame','dev'],
        'microframe' => ['Microframe', '/report/microframe', 'List of all microframes.','ui::icon.microframe','dev'],
