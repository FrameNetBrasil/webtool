...
return [
    'fnbr' => ['mainPanel', 'main/main', 'fnbrIconForm', '', '', [
        'admin' => ['Admin', 'admin/main', 'fa fa-cogs fa16px', 'ADMIN', A_ACCESS, [
            ...
            'relationgroupstructure' => ['Relation Group', 'admin/relationgroup/main', 'fa fa-sitemap fa16px', 'ADMIN', A_ACCESS, []],
            'relationtypestructure' => ['Relation Type', 'admin/relationtype/main', 'fa fa-crosshairs fa16px', 'ADMIN', A_ACCESS, []],
            'layergroupstructure' => ['Layer Group', 'admin/layergroup/main', 'fa fa-sitemap fa16px', 'ADMIN', A_ACCESS, []],
            'layertypestructure' => ['Layer Type', 'admin/layertype/main', 'fa fa-crosshairs fa16px', 'ADMIN', A_ACCESS, []],
        ]],
...
//            'templatestructure' => ['Template', 'structure/template/main', 'fa fa-files-o fa16px', 'MASTER', A_ACCESS, []],
        ...
        'annotation' => ['Annotation', 'annotation/main', 'fa fa-align-justify fa16px', '', A_ACCESS, [
            ...
            'dynamicAnnotation' => ['Dynamic Mode', 'annotation/dynamic/formVideoAnnotation', 'fa fa-file-video fa16px', '', A_ACCESS, []],
        ...
        'utils' => ['Utils', 'main/utils/', 'fa fa-briefcase fa16px', 'MASTER', A_ACCESS, [
            ...
            'registerLemma' => ['Register Lemma', 'utils/register/formRegisterLemma', 'fa fa-upload fa16px', 'MASTER', A_ACCESS, []],
