...
return [
    'fnbr' => ['mainPanel', 'main/main', 'fnbrIconForm', '', '', [
        ...
        'utils' => ['Utils', 'main/utils/', 'fa fa-briefcase fa16px', 'MASTER', A_ACCESS, [
            ...
            'exportXML' => ['Export XML Doc', 'utils/export/formExportXML', 'fa fa-download fa16px', 'MASTER', A_ACCESS, []],
            'exportCONLLU' => ['Export CONLLU Doc', 'utils/export/formExportCONLLU', 'fa fa-download fa16px', 'MASTER', A_ACCESS, []],
