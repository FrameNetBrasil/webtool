...
var Notify = /** @class */ (function () {
    function Notify(args) {
        ...
        var status = args.status, _a = args.type, type = _a === void 0 ? 1 : _a, title = args.title, text = args.text, _b = args.showIcon, showIcon = _b === void 0 ? true : _b, customIcon = args.customIcon, customClass = args.customClass, _c = args.speed, speed = _c === void 0 ? 500 : _c, _d = args.effect, effect = _d === void 0 ? 'fade' : _d, _e = args.showCloseButton, showCloseButton = _e === void 0 ? true : _e, _f = args.autoclose, autoclose = _f === void 0 ? false : _f, _g = args.autotimeout, autotimeout = _g === void 0 ? 3000 : _g, _h = args.gap, gap = _h === void 0 ? 20 : _h, _j = args.distance, distance = _j === void 0 ? 20 : _j, _k = args.position, position = _k === void 0 ? 'right top' : _k;
        this.status = status;
        this.title = title;
        this.text = text;
