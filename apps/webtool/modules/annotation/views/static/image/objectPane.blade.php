<script>
    let objectPane = {
        ...
        methods: {
            ...
            updateObject() {
                let params = {
                    idSentenceMM: this.$store.state.model.sentence.idSentenceMM,
                    //idObjectMM: this.currentObject.idObjectMM,
                    idObjectSentenceMM: this.currentObject.idObjectSentenceMM,
                    startTime: 0.0,
                    endTime: 0.0,
                ...
                try {
                    ...
                    console.log(params);
                    let url = "/index.php/webtool/annotation/multimodal/updateImageObject";
                    manager.doAjax(url, (response) => {
