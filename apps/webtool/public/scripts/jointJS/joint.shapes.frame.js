...
joint.shapes.frame.Frame = joint.shapes.basic.Rect.extend({
...
joint.shapes.frame.FrameElement = joint.shapes.basic.Generic.extend(_.extend({}, joint.shapes.basic.PortsModelInterface, {
...
joint.shapes.frame.Relation = joint.dia.Link.extend({
    defaults: joint.util.deepSupplement({
        type: 'frame.Relation',
        attrs: {
...
joint.shapes.frame.RelationView = joint.dia.LinkView.extend({
    pointerdown: function(evt) {
        joint.dia.LinkView.prototype.pointerdown.apply(this, arguments);
    }
});

joint.shapes.frame.FrameElementView = joint.dia.ElementView.extend(joint.shapes.basic.PortsViewInterface);


if (typeof exports === 'object') {

    module.exports = joint.shapes.frame;
}
