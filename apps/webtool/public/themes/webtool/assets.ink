...
scripts/jQuery-Mask-Plugin-master/dist/jquery.mask.min.js
...
scripts/jointJS/lodash.min.js
scripts/jointJS/backbone-min.js
scripts/jointJS/joint.min.js
scripts/jointJS/joint.shapes.devs.js
scripts/jointJS/joint.shapes.frame.js
